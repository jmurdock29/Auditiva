...
@Component({
  selector: 'app-tb-profesor',
  templateUrl: './tb-profesor.component.html',
  styleUrls: ['./tb-profesor.component.css']
})
export class TbProfesorComponent implements OnInit {
  ...
  openModalProfesor()
    {
        this.modalService.open(ConslProfesorComponent,
