...
@Component({
  selector: 'app-md-estudiante',
  templateUrl: './md-estudiante.component.html',
  styleUrls: ['./md-estudiante.component.css']
})
export class MdEstudianteComponent implements OnInit {
  profesor:Profesor;
  sprofesor:string;
   constructor(
