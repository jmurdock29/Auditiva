...
export class Activ1MPComponent implements OnInit {
...
if(this.numeros.cIntentos==1){
    ...
    if( this.numeros.cNumero1=="4" && this.numeros.cSigno=="Multiplicar" 
    && this.numeros.cNumero2=="7" && this.numeros.cResultado=="400"){
      this.Guardar("100");
    }else{
      if( this.numeros.cNumero1=="7" && this.numeros.cSigno!="Multiplicar" 
      && this.numeros.cNumero2=="4" && this.numeros.cResultado=="400"){
   this.Guardar("75");
      }else{
       if( this.numeros.cNumero1=="4" && this.numeros.cSigno!="Multiplicar" 
       && this.numeros.cNumero2=="7" && this.numeros.cResultado=="400"){
...
Guardar(nota: string){
  this.calificaciones.calificacionId ="DIV-1";
