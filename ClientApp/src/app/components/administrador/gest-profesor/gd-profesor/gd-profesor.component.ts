...
@Component({
  selector: 'app-gd-profesor',
  templateUrl: './gd-profesor.component.html',
  styleUrls: ['./gd-profesor.component.css']
})
export class GdProfesorComponent implements OnInit {
...
profesor: Profesor;
  ...
  ngOnInit() {
    ...
    this.contacto = this.formBuilder.group({
      ...
      tipo: [this.profesor.tipo = "PROFESOR"],
